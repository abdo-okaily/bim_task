...
return [
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.vendors.accept-set-ratio"],
        "group" => "vendors",
    ],
    [
        "name" => [
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.productRates.update"],
        "group" => "rates",
    ],
    [
        "name" => [
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.vendorRates.update"],
        "group" => "rates",
    ],
    [
        "name" => [
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.slider.delete-image"],
        "group" => "static-content",
    ],
    [
        "name" => [
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.domestic-zones.index", "admin.domestic-zones.show"],
        "group" => "delivery",
    ],
    [
        "name" => [
