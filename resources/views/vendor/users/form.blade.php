    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.user_name')<span class="required" >*</span></label>
                    {{ Form::text('name',null,['class'=>'form-control','id'=>'name-input','placeholder'=> __('translation.name_placeholder'),'required']) }}
                    @error('name')
                ...
                <div class="mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.email')<span class="required" >*</span></label>
                ...
                <div class="mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.phone')<span class="required" >*</span></label>
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1"><i class=" ri-phone-fill"></i></span>
                        {{ Form::number('phone',null,['class'=>'form-control','id'=>'phone-input','placeholder'=> __('translation.phone_placeholder'),'required']) }}
                    </div>
                    @error('phone')
                        <span class="invalid-feedback" style="display:inline;" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.roles')<span class="required" >*</span></label>
        ...
        <div class="card">
            <div class="card-body row">
                <div class="col-md-6 mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.password')<span class="required" >@if(!isset($row))*@endif</span></label>
                    <div class="input-group">
                ...
                <div class="col-md-6 mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.confirm_password')<span class="required" >@if(!isset($row))*@endif</span></label>
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1"><i class=" ri-lock-fill"></i></span>
        ...
        <!-- end card -->        <div class="text-end mb-3">
