                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index" class="d-inline-block auth-logo">
                                    <img src="{{ URL::asset('white_logo.svg') }}" alt="" height="80" >
                                </a>
                            </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form class="row" novalidate method="POST"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="useremail" class="form-label">@lang('translation.owner_store_name') <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                name="name" value="{{ old('name') }}" id="userowner_store_name"
                                                placeholder="@lang('translation.owner_store_name')">
                                            @error('name')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="username" class="form-label">@lang('translation.store_name') <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control @error('store_name') is-invalid @enderror"
                                                name="store_name" value="{{old('store_name')}}" id="store_name"
                                                placeholder="@lang('translation.store_name_placeholder')">
                                            @error('store_name')
                                                <span class="invalid-feedback d-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div>
                                                <label for="exampleFormControlTextarea5" class="form-label">@lang('translation.desc')</label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="username" class="form-label">@lang('translation.broc') <span
                                                    class="text-danger">*</span></label>
...
{{-- 
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit">@lang('translation.signup')</button>
                                        </div>
