               ...
               <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">@lang('translation.app_name')</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2">
                                    <form action="{{route('vendor.password.update')}}" method="POST">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit">@lang('translation.reset_password')</button>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Suadi Dates. Crafted with <i class="mdi mdi-heart text-danger"></i> by Houya</p>
                        </div>
                    </div>
                </div>
            </div>
