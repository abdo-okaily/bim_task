...
@section('script')
    ...
    <script>
        ...
        var vendorFiles=['#broc','#cr','#tax_certificate']; // files with vendor table
        vendorFiles.forEach((value,index)=>{
            let vendorFile = document.querySelector(value);
            let exsitFile='';
            if (value==='#broc') {
                exsitFile='/{{$row->my_vendor->broc}}';
            }
            if (value==='#cr') {
                exsitFile='/{{$row->my_vendor->cr}}';
            }
            if (value==='#tax_certificate') {
                exsitFile='/{{$row->my_vendor->tax_certificate}}';
            }
