    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="mb-3 position-relative">
                ...
                <div class="input-group has-validation">
                    <input type="text" class="form-control @if($errors->has('name'))invalid-input @endif" name="name" id="firstnameInput" aria-describedby="inputGroupPrepend" placeholder="@lang('translation.name_placeholder')" value="{{$row->name}}" required>
                    @if($errors->has('name'))
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <div class="input-group has-validation">
                    <input type="text" class="form-control @if($errors->has('phone'))invalid-input @endif" name="phone" id="phonenumberInput" aria-describedby="inputGroupPrepend"
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <!-- <div class="input-group has-validation"> -->
                    <input type="email" class="form-control @if($errors->has('email'))invalid-input @endif" name="email" id="emailInput" aria-describedby="inputGroupPrepend" placeholder="@lang('translation.email_placeholder')" value="{{$row->email}}" required>
                    @if($errors->has('email'))
