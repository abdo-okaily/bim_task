...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route("vendor.index") }}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ url('images/logo.svg') }}" alt="" height="80">
            </span>
            <span class="logo-lg">
                <img src="{{ url('images/logo.svg') }}" alt="" height="80">
            </span>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('vendor.products.index')}}" class="nav-link">@lang('translation.products_list')</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('vendor.products.create')}}" class="nav-link">@lang('translation.create_product')</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarOrders" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarOrders">
                        <i class="ri-shopping-cart-fill"></i> <span>@lang('translation.orders')</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('vendor.product-reviews')}}">
                        <i class=" ri-star-half-line"></i> <span>@lang('translation.reviews')</span>
                    </a>
                </li>
                <li class="nav-item">
