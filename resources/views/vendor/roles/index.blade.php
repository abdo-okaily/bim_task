                    ...
                    <div class="col-sm-auto">
                        <div>
                            <a href="{{route('vendor.roles.create')}}" class="btn btn-success" id="addrole-btn"><i
                                    class="ri-add-line align-bottom me-1"></i> @lang('translation.create_role')</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <!-- <div class="card-header">
                                    <h5 class="card-title mb-0">@lang('translation.roles')</h5>
                                </div> -->
                                <div class="card-body">
                                    {{ $dataTable->table() }}
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    ...
                    <button type="button" class="btn w-sm btn-primary" id="delete-user"  onclick="deleteRole($(this))">@lang('translation.yes_delete_it')</button>
                </div>
            </div>
...
<script>
    var role_id
    function showDeleteModal(role_data_id)
    {
