                        ...
                        <div class="col-xxl-2 col-sm-4">
                            <div>
                                <select class="form-control" data-choices data-choices-search-false name="status" id="idStatus">
                                        <option value="all">@lang('translation.all_orders')</option>
                                    @foreach($statuses as $status)
                                        <option value="{{$status['value']}}" @if(isset($request) && $status['value'] == $request->status) selected @endif>{{$status['name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
