                                    ...
                                    <div class="tab-pane fade active show" id="categories-arabic-info" role="tabpanel"
                                        ...
                                        <div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="short_desc_ar" class="form-control"
                                                            placeholder="@lang('admin.recipes.short_desc_ar')">{{ old("short_desc_ar") }}</textarea>
                                                        @error('short_desc_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="slug_ar">@lang('admin.recipes.body_ar')</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="short_desc_en" class="form-control"
                                                            placeholder="@lang('admin.recipes.short_desc_en')">{{ old("short_desc_en") }}</textarea>
                                                        @error('short_desc_en')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
