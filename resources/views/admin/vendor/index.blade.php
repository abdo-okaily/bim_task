                        ...
                        <div class="row g-3">
                            <div class="col-xxl-3 col-sm-4">
                                <div class="search-box">
                                    <input value="{{ request('name') }}" name="name" type="text" class="form-control search" placeholder="@lang('admin.vendor_name')">
                            ...
                            <div class="col-xxl-2 col-sm-4">
                                <select name="approval" class="form-control" data-choices data-choices-search-false name="choices-single-default" id="idApproval">
                                    <option @if(request('approval') == '') SELECTED @endif value="">@lang('admin.vendor_status')</option>
                                    <option @if(request('approval') == 'pending') SELECTED @endif value="pending">@lang('admin.vendor_pending')</option>
                                    <option @if(request('approval') == 'approved') SELECTED @endif value="approved">@lang('admin.vendor_approved')</option>
                                    <option @if(request('approval') == 'not_approved') SELECTED @endif value="not_approved">@lang('admin.vendor_not_approved')</option>
                                </select>
                            </div>
                            <div class="col-xxl-2 col-sm-4">
                                <select name="rating" class="form-control" data-choices data-choices-search-false name="choices-single-default" id="idRating">
                                    <option @if(request('rating') == '') SELECTED @endif value="">@lang('admin.vendor_rate')</option>
                                    <option @if(request('rating') == '1') SELECTED @endif value="1"><i class="fas fa-star {{ (request('rating') >= 1) ? 'clr_yellow' : '' }}"></i></option>
                                    <option @if(request('rating') == '1') SELECTED @endif value="1"><i class="fas fa-star {{ (request('rating') >= 1) ? 'clr_yellow' : '' }}"></i></option>
                                    <option @if(request('rating') == '2') SELECTED @endif value="2"><i class="fas fa-star {{ (request('rating') >= 2) ? 'clr_yellow' : '' }}"></i></option>
                                    <option @if(request('rating') == '3') SELECTED @endif value="3"><i class="fas fa-star {{ (request('rating') >= 3) ? 'clr_yellow' : '' }}"></i></option>
                                    <option @if(request('rating') == '4') SELECTED @endif value="4"><i class="fas fa-star {{ (request('rating') >= 4) ? 'clr_yellow' : '' }}"></i></option>
                                    <option @if(request('rating') == '5') SELECTED @endif value="5"><i class="fas fa-star {{ (request('rating') >= 5) ? 'clr_yellow' : '' }}"></i></option>
                                </select>
                            </div>
                            <div class="col-xxl-4 col-sm-4">
                                <select name="commission_sort" class="form-control" data-choices data-choices-search-false name="choices-single-default" id="idCommission">
                                    <option @if(request('commission_sort') == '') SELECTED @endif value="">@lang('admin.vendor_admin_percentage_order')</option>
                                    <option @if(request('commission_sort') == 'desc') SELECTED @endif value="desc">@lang('admin.desc_order')</option>
                                    <option @if(request('commission_sort') == 'asc') SELECTED @endif value="asc">@lang('admin.asc_order')</option>
                                </select>
                            </div>
                    ...
                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                        ...
                        @foreach ($vendors as $vendor)
                            <tr>
                                <td>{{ $vendor->id }}</td>
                                <td>
                                    <img class="img-thumbnail" src="{{ URL::asset($vendor->logo) }}"
                                ...
                                <td style="width: 114px; !important">
                                    <div class="stars">
                                        <i class="fas fa-star {{ ($vendor->avg_rating >= 1) ? 'clr_yellow' : '' }}"></i>
                                        <i class="fas fa-star {{ ($vendor->avg_rating >= 2) ? 'clr_yellow' : '' }}"></i>
                                        <i class="fas fa-star {{ ($vendor->avg_rating >= 3) ? 'clr_yellow' : '' }}"></i>
                                        <i class="fas fa-star {{ ($vendor->avg_rating >= 4) ? 'clr_yellow' : '' }}"></i>
                                        <i class="fas fa-star {{ ($vendor->avg_rating >= 5) ? 'clr_yellow' : '' }}"></i>
                                ...
                                <td>
                                    <div class="hstack gap-3 flex-wrap">
                                            ...
                                            <a href="javascript:void(0);" onclick="set_accept_to_vendor('{{ $vendor->id }}',this);">
                                                <i id="vendor_approve_icon" class="ri-check-fill"></i>
                                            </a>
                                            @else
                                            <a href="javascript:void(0);" onclick="vendorApprove('{{ $vendor->id }}',this);">
                                                <i id="vendor_approve_icon" class="link-danger ri-indeterminate-circle-fill"></i>
                                            </a>
                                            @endif

                                        <a href="{{ route('admin.vendors.show', ['vendor' => $vendor]) }}" class="fs-15">
                                            <i class="ri-eye-line"></i>
                                        </a>
                                        <a href="{{ route('admin.vendors.edit', ['vendor' => $vendor]) }}" class="fs-15">
