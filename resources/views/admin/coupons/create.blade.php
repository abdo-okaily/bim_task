                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="title_ar" class="form-control" value="{{ old("title_ar") }}" id="name_ar" placeholder="{{ trans('admin.coupons.title_ar') }}">
                                                        @error('title_ar')
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="title_en" class="form-control" value="{{ old("title_en") }}" id="title_en" placeholder="{{ trans('admin.coupons.title_en') }}">
                                                        @error('title_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="code" class="form-control" value="{{ old("code") }}" id="code" placeholder="{{ trans('admin.coupons.code') }}">
                                                        @error('code')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select onchange="handle_coupon_type(this);" class="select2 form-control" name="coupon_type" id="select2_coupon_type">
                                                            ...
                                                            <option @selected($couponType["value"] == old('coupon_type'))
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input min="1" step="0.01" name="amount" class="form-control" value="{{ old("amount") }}" id="amount" placeholder="{{ trans('admin.coupons.amount') }}">
                                                        @error('amount')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input min="1" step="0.01" name="minimum_order_amount" class="form-control" value="{{ old("minimum_order_amount") }}" id="minimum_order_amount" placeholder="{{ trans('admin.coupons.minimum_order_amount') }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input min="1" step="0.01" name="maximum_discount_amount" class="form-control" value="{{ old("maximum_discount_amount") }}" id="maximum_discount_amount" placeholder="{{ trans('admin.coupons.maximum_discount_amount') }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input min="0" name="maximum_redemptions_per_user" class="form-control" value="{{ old("maximum_redemptions_per_user") }}" id="maximum_redemptions_per_user" placeholder="{{ trans('admin.coupons.maximum_redemptions_per_user') }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input min="0" name="maximum_redemptions_per_coupon" class="form-control" value="{{ old("maximum_redemptions_per_coupon") }}" id="maximum_redemptions_per_coupon" placeholder="{{ trans('admin.coupons.maximum_redemptions_per_coupon') }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input value="{{ old('start_at') }}" name="start_at" type="text" class="form-control flatpickr-input active" data-provider="flatpickr"  data-minDate="today" data-date-format="Y-m-d" placeholder="@lang('admin.from')">
                                                        @error('start_at')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input value="{{ old('expire_at') }}" name="expire_at" type="text" class="form-control flatpickr-input active" data-provider="flatpickr"  data-minDate="today" data-date-format="Y-m-d" placeholder="@lang('admin.to')">
                                                        @error('expire_at')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
