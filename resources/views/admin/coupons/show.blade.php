                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input disabled readonly type="text" name="title_ar" class="form-control" id="title_ar" value="{{ $coupon->getTranslation('title', 'ar') }}" placeholder="{{ trans('admin.coupons.title_ar') }}">
                                @error('title_ar')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input disabled readonly type="text" name="title_en" class="form-control" id="title_en" value="{{ $coupon->getTranslation('title', 'en') }}" placeholder="{{ trans('admin.coupons.title_en') }}">
                                @error('title_en')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
