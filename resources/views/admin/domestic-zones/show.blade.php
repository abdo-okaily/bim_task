            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-right">
                        <p class="mb-3">@lang('admin.delivery.domestic-zones.name-ar'): {{ $domesticZone->getTranslation('name', 'ar') }}</p>
                        <p class="mb-3">@lang('admin.delivery.domestic-zones.name-en'): {{ $domesticZone->getTranslation('name', 'en') }}</p>
