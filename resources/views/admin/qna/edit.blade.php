                                ...
                                <div class="step-arrow-nav mb-4">
                                    <ul class="nav nav-pills custom-nav nav-justified" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link" id="categories-english-info-tab"
                                                    data-bs-toggle="pill"
                                                ...
                                                @if ($errors->has('question_en') || $errors->has('question_en'))
                                                    <span
                                                            class="badge bg-danger">{{ trans('admin.errors') . ' edit.blade.php' . count([$errors->has('question_en'), $errors->has('question_en')]) }}</span>
                                                @endif
                                            </button>
                                        </li>
                                    </ul>
                                        ...
                                        <div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                               for="question_ar">@lang('admin.qnas.question_ar')</label>
                                                        <input type="text" name="question_ar" class="form-control"
                                                               id="question_ar"
                                                               value="{{ $qna->getTranslation('question', 'ar') }}"
                                                               placeholder="{{ trans('admin.qnas.question_ar') }}">
                                                        @error('question_ar')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                               for="slug_ar">@lang('qnas.admin.answer_ar')</label>

                                                        <textarea name="answer_ar" class="ckeditor form-control"
                                                                  placeholder="@lang('qnas.admin.answer_ar')">{{ $qna->getTranslation('answer', 'ar') }}</textarea>
                                                        @error('answer_ar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                               for="question_en">@lang('admin.qnas.question_en')</label>
                                                        <input type="text" name="question_en" class="form-control"
                                                               id="question_en"
                                                               value="{{ $qna->getTranslation('question', 'en') }}"
                                                               placeholder="{{ trans('admin.qnas.question_en') }}">
                                                        @error('question_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label"
                                                               for="slug_en">@lang('qnas.admin.answer_en')</label>

                                                        <textarea name="answer_en" class="ckeditor form-control"
                                                                  placeholder="@lang('qnas.admin.answer_en')">{{ $qna->getTranslation('answer', 'en') }}</textarea>
