                                    ...
                                    <ul class="nav nav-pills custom-nav nav-justified" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="categories-english-info-tab" data-bs-toggle="pill"
                                                ...
                                                @if ($errors->has('body_en') || $errors->has('title_en') || $errors->has('short_desc_en') )
                                                    <span
                                                        class="badge bg-danger">{{ trans('admin.errors') . ' ' . count([$errors->has('title_en'), $errors->has('body_en'), $errors->has('short_desc_en')]) }}</span>
                                                @endif
                                            </button>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-pane fade active show" id="categories-arabic-info" role="tabpanel"
                                        ...
                                        <div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="short_desc_ar" class="form-control"
                                                            placeholder="@lang('admin.blogPosts.short_desc_ar')">{{ old("short_desc_ar") }}</textarea>
                                                        @error('short_desc_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="slug_ar">@lang('admin.blogPosts.body_ar')</label>
                                                        
                                                        <textarea class="form-control" id="body_ar" name="body_ar"></textarea>
                                                        @error('body_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="short_desc_en" class="form-control"
                                                            placeholder="@lang('admin.blogPosts.short_desc_en')">{{ old("short_desc_en") }}</textarea>
                                                        @error('short_desc_en')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
