                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{ route('admin.login') }}" method="POST">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit">{{ __('admin.sign') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Saudi Dates. Crafted with <i class="mdi mdi-heart text-danger"></i> by Houya</p>
                        </div>
                    </div>
                </div>
            </div>
