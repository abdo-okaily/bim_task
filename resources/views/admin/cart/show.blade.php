                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <input disabled="disabled" readonly type="text" class="form-control" value="{{ $cart->user->name }}" id="basicInput">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div>
                                    <label for="BasicInput" class="form-label">@lang('admin.customer_phone')</label>
                                    <input disabled="disabled" readonly type="text" class="form-control" value="{{ $cart->user->phone }}" id="basicInput">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div>
                                    <label for="BasicInput" class="form-label">@lang('admin.customer_email')</label>
                                    <input disabled="disabled" readonly type="text" class="form-control" value="{{ $cart->user->email }}" id="basicInput">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-nowrap">
                            ...
                            @foreach($cart->products As $product)
                                <tr>
                                    ...
                                    <td>{{ $product->name }}</td>
                                    <td>{{ ($product->price/100) .'  '. __('translation.sar') }}</td>
