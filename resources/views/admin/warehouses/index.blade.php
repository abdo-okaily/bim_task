        ...
        <div class="col-lg-12">
            <div class="card" id="warehouses">
                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form action="{{ route("admin.warehouses.index") }}">
                        <div class="row g-3">
                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="warehousesTable">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th>@lang('admin.warehouses.name_ar')</th>
                                    <th>@lang('admin.warehouses.name_en')</th>
                                    <th>@lang('admin.warehouses.torod_warehouse_name')</th>
                                    <th>@lang('admin.warehouses.administrator_name')</th>
                                    <th>@lang('admin.warehouses.administrator_phone')</th>
                                    <th>@lang('admin.warehouses.administrator_email')</th>
                                    ...
                                    @if ($warehouses->count() > 0)
                                        @foreach($warehouses as $warehouse)
                                            <tr>
                                                ...
                                                <td class="name_ar">{{ $warehouse->getTranslation('name', 'ar') }}</td>
                                                <td class="name_en">{{ $warehouse->getTranslation('name', 'en') }}</td>
                                                <td class="torod_warehouse_name">{{ !empty($warehouse->torod_warehouse_name) ? $warehouse->torod_warehouse_name : trans("admin.warehouses.not_found") }}</td>
                                                <td class="administrator_name">{{ $warehouse->administrator_name }}</td>
                                                <td class="administrator_phone">{{ $warehouse->administrator_phone }}</td>
                                                <td class="administrator_email">{{ $warehouse->administrator_email }}</td>
                                                <td>
