    ...
    <div class="col-lg-8">
        ...
        <div class="card card-ar">
            <div class="card-body">
                <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label" for="product-name-input">@lang('translation.product_name')<span class="required" style="color: red!important">*</span> (@lang('admin.products.arabic_date')) </label>
        ...
        <div class="card card-en">
            <div class="card-body">
                <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label" for="product-name-inputs">@lang('translation.product_name')<span class="required" style="color: red!important">*</span> (@lang('admin.products.english_date'))</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="text" step=".01" min="0.01" oninput="validatePrice(this)"    name="price_before_offer" id="price_before_offer" value="{{ $row->price_before_offer_in_sar ?? old('price_before_offer') }}" placeholder="{{trans('translation.price_before_offer_placeholder')}}" class="form-control" aria-label="Price" aria-describedby="product-price-addon" required>
        ...
        <div class="card ">
            ...
            <div class="card-body">
                ...
                <div class="mb-3" style="margin-top: 10px;">
                    ...
                    {{ Form::text('sku', $row->sku, ['class'=>'form-control','id'=>'sku-input','placeholder'=> __('translation.sku_placeholder'),'aria-label'=>'Stock','aria-describedby'=>'product-sku-addon']) }}
                    @error('sku')
                        <span class="error text-danger"> {{ $message }} </span>
                    @enderror
                </div>
