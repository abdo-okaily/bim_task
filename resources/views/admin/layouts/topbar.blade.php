            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('images/logo.svg') }}" alt="" height="80" style="background-color:white;">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('images/logo.svg') }}" alt="" height="80" style="background-color:white;">
                        </span>
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        {{--@if(auth()->user()->unreadNotifications->count() > 0)
                            <span id="notification-counter" class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">{{ auth()->user()->unreadNotifications->count() }}<span class="visually-hidden">@lang('admin.notifications.unread')</span></span>
                        @endif--}}
                    </button>
                        ...
                        <div class="dropdown-head bg-primary bg-pattern rounded-top">
                            <div class="p-3">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="m-0 fs-16 fw-semibold text-white">@lang('admin.notifications.notifications')</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
