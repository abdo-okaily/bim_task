                                    ...
                                    <div class="tab-pane fade active show" id="cities-arabic-info" role="tabpanel" aria-labelledby="cities-arabic-info-tab">
                                        <div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="name_ar">@lang('admin.cities.name_ar')</label>
                                                        <input type="text" name="name_ar" class="form-control"
                                                            value="{{ old("name_ar") }}"
                                                            id="name_ar"
                                                            placeholder="{{ trans('admin.cities.name_ar') }}">
                                                        @error('name_ar')
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="name_en">@lang('admin.cities.name_en')</label>
                                                        <input type="text" name="name_en" class="form-control"
                                                            value="{{ old("name_en") }}"
                                                            id="name_en"
                                                            placeholder="{{ trans('admin.cities.name_en') }}">
                                                        @error('name_en')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                            ...
                                                            @if($areas->count() > 0)
                                                                @foreach ($areas as $area)
                                                                    <option value="{{ $area->id }}">
                                                                        {{ $area->getTranslation("name", "ar") }} - {{ $area->getTranslation("name", "en") }}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                        </select>
