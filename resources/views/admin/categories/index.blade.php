                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form action="{{ route("admin.categories.index") }}">
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <select class="form-control" data-choices data-choices-search-false name="trans" id="trans">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                            ...
                            <li class="nav-item">
                                <form action="{{ route("admin.categories.index") }}" method="get">
                                    ...
                                    <button class="nav-link py-3 {{ request()->has("is_active") && request()->is_active ==  1 ? 'active' : '' }}"
                                            data-bs-toggle="tab" id="active" role="tab" aria-selected="false">
                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="categoriesTable">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th>@lang('admin.categories.name_en')</th>
                                ...
                                @foreach($categories as $category)
                                    <tr data-id="{{ $category->id }}" data-order="{{$category->order}}">
                                        ...
                                        <td>
                                            <a href="{{ route("admin.categories.show", ["id" => $category->id, "type" => 1]) }}" class="fw-medium link-primary">
                                                #{{$category->id}}
                                            </a>
                                        </td>
                                        <td>
