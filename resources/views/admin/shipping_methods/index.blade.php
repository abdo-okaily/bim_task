                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="shippingMethodsTable">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th>@lang('admin.shippingMethods.name_en')</th>
                                    <th>@lang('admin.shippingMethods.integration_key')</th>
                                    <th>@lang('admin.shippingMethods.delivery_fees')</th>
                                    <th>@lang('admin.shippingMethods.delivery_fees_covered_kilos')</th>
                                    <th>@lang('admin.shippingMethods.cod_collect_fees')</th>
                                    ...
                                    @if ($shippingMethods->count() > 0)
                                        @foreach($shippingMethods as $shippingMethod)
                                            <tr>
                                                ...
                                                <td class="name_en">{{ $shippingMethod->getTranslation('name', 'en') }}</td>
                                                <td class="is_active">
                                                ...
                                                <td class="name_en">{{ $shippingMethod->delivery_fees }} @lang('translation.sar')</td>
                                                <td class="name_en">{{ $shippingMethod->delivery_fees_covered_kilos }} @lang('translation.kilo')</td>
                                                <td class="name_en">{{ $shippingMethod->cod_collect_fees }} @lang('translation.sar')</td>
                                                <td>
                                                    <span class="{{ \App\Enums\ShippingMethodKeys::getKeys()[$shippingMethod->integration_key] ?? '' }}">
