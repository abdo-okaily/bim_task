<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3" >
                    <label for="choices-publish-status-input" class="form-label"><?php echo app('translator')->get('translation.main_category'); ?><span class="required" style="color: red!important">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <label for="choices-publish-status-input" class="form-label"><?php echo app('translator')->get('admin.products.vendor'); ?><span class="required" style="color: red!important">*</span></label>
                    <?php echo e(Form::select('vendor_id', $vendors, $row->vendor_id ?? old('vendor_id'), ['class'=>'form-select','id'=>'main-choices-input-vendor_id', 'placeholder'=>__('admin.products.vendor'),'data-choices','data-choices-search-true',])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card card-ar">
            <div class="card-body">
                <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label" for="product-name-input"><?php echo app('translator')->get('translation.product_name'); ?><span class="required" style="color: red!important">*</span> (<?php echo app('translator')->get('admin.products.arabic_date'); ?>) </label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <input type="hidden" name="desc_ar" id="desc-hidden">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card card-en">
            <div class="card-body">
                <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label" for="product-name-inputs"><?php echo app('translator')->get('translation.product_name'); ?><span class="required" style="color: red!important">*</span> (<?php echo app('translator')->get('admin.products.english_date'); ?>)</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <input type="hidden" name="desc_en" id="desc-hiddens">
                    <label><?php echo app('translator')->get('translation.product_desc'); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-4">
                    <h5 class="fs-14 mb-1"><?php echo app('translator')->get('translation.product_image'); ?><span class="required" style="color: red!important">*</span></h5>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 col-sm-6">
                        <div class="mb-4">
                            <label class="form-label" for="manufacturer-name-input"><?php echo app('translator')->get('translation.total_weight'); ?> <?php echo app('translator')->get('translation.gram'); ?><span class="required" style="color: red!important">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-2">
                            <label class="form-label" for="manufacturer-name-input"><?php echo app('translator')->get('translation.net_weight'); ?> <?php echo app('translator')->get('translation.gram'); ?><span class="required" style="color: red!important">*</span></label>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-3">
                            <label class="form-label" for="product-price-input"><?php echo app('translator')->get('translation.price'); ?> <?php echo app('translator')->get('translation.sar'); ?><span class="required" style="color: red!important">*</span></label>
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="text" step=".01" min="0.01"  oninput="validatePrice(this)" name="price" id="price" value="<?php echo e($row->price_in_sar ?? old('price')); ?>" placeholder="<?php echo e(trans('translation.price_placeholder')); ?>" class="form-control" aria-label="Price" aria-describedby="product-price-addon" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="text" step=".01" min="0.01" oninput="validatePrice(this)"    name="price_before_offer" id="price_before_offer" value="<?php echo e($row->price_before_offer_in_sar ?? old('price_before_offer')); ?>" placeholder="<?php echo e(trans('translation.price_before_offer_placeholder')); ?>" class="form-control" aria-label="Price" aria-describedby="product-price-addon" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3" style="margin-top: 10px;">
                    <label for="choices-publish-status-input" class="form-label"><?php echo app('translator')->get('translation.quantity_type'); ?><span class="required" style="color: red!important">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if(isset($row)): ?>
                <div class="mb-3" style="margin-top: 10px;">
                    <label for="choices-publish-status-input" class="form-label"><?php echo app('translator')->get('translation.stock'); ?></label>
                    <?php echo e(Form::number('stock', $row->stock, ['class'=>'form-control','id'=>'stock-input','placeholder'=> __('translation.stock_placeholder'),'aria-label'=>'Stock','aria-describedby'=>'product-stock-addon'])); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3" style="margin-top: 10px;">
                    <label for="choices-publish-status-input" class="form-label"><?php echo app('translator')->get('translation.sku'); ?></label>
                    <?php echo e(Form::text('sku', $row->sku, ['class'=>'form-control','id'=>'sku-input','placeholder'=> __('translation.sku_placeholder'),'aria-label'=>'Stock','aria-describedby'=>'product-sku-addon'])); ?>
...
<?php /**PATH /Users/abdo/Sites/localhost/saudi-dates/resources/views/admin/products/form.blade.php ENDPATH**/ ?>