<?php if(config('sweetalert.alwaysLoadJS') === true && config('sweetalert.neverLoadJS') === false ): ?>
    <script src="<?php echo e($cdn ?? asset('vendors/sweetalert/sweetalert.all.js')); ?>"></script>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/abdo/Sites/localhost/saudi-dates/resources/views/vendor/sweetalert/alert.blade.php ENDPATH**/ ?>