                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="<?php echo e(route("admin.products.create")); ?>" class="btn btn-primary add-btn"
                                   id="create-btn">
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-5 col-sm-6">
                                <div class="search-box">
                                    <input type="text" class="form-control search" name="search" value="<?php echo e(request()->get('search')); ?>"
                                           placeholder="<?php echo app('translator')->get("admin.products.search"); ?>">
                            ...
                            <div class="col-xxl-2 col-sm-6">
                                <div>
                                    <input type="text" class="form-control" data-provider="flatpickr" name="created_date"
                                        data-date-format="d M, Y" data-range-date="true" id="demo-datepicker" value="<?php echo e(request()->get('created_date')); ?>"
                                        placeholder="<?php echo app('translator')->get("admin.products.created_at_select"); ?>">
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <select class="form-control" data-choices data-choices-search-false
                                        ...
                                        <option value="all" selected><?php echo app('translator')->get("admin.select"); ?></option>
                                        <option <?php if(request()->get('active_status') == "active"): echo 'selected'; endif; ?> value="active"><?php echo app('translator')->get("admin.products.active"); ?></option>
                                        <option <?php if(request()->get('active_status') == "inactive"): echo 'selected'; endif; ?> value="inactive"><?php echo app('translator')->get("admin.products.inactive"); ?></option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <?php if($products->count() > 0): ?>
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="product-<?php echo e($product->id); ?>">
                                                ...
                                                <td class="status">
                                                    <?php if($product?->status == 'accepted'): ?>
                                                        <span class="badge badge-soft-success text-uppercase"> <?php echo app('translator')->get('admin.products.yes'); ?></span>
                                                    <?php else: ?>
                                                        <span class="badge badge-soft-danger text-uppercase"><?php echo app('translator')->get("admin.products.{$product->status}"); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <?php if(request()->has('status') && request('status') == 'pending'): ?>
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="<?php echo app('translator')->get('admin.products.accepting'); ?>">
                                                            <a href="javascript:void(0);" onclick="productApprove('<?php echo e($product->id); ?>');">
...
<?php $__env->startSection('script-bottom'); ?>
    <script>
        function productApprove(productId)
        {
            ...
            $.post("<?php echo e(URL::asset('/admin')); ?>/products/approve/" + productId, {
                id: productId,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/abdo/Sites/localhost/saudi-dates/resources/views/admin/products/index.blade.php ENDPATH**/ ?>