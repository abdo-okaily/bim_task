...
class CustomerWithdrawRequestUpdate extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'bank_receipt' => 'required_if:status,'. CustomerWithdrawRequestEnum::APPROVED.'|image|max:2048'
        ];
    }
    ...
    public function messages() : array {
        return [
            ...
            'bank_receipt.image' => __('admin.customer_finances.customer-cash-withdraw.validations.bank_receipt-image'),
