...
class CouponStorFormRequest extends FormRequest
{
    ...
    {
        $return = [
            'title_ar' => ["required", "string", "min:3",'max:90'],
            'title_en' => ["required", "string", "min:3",'max:90'],
            ...
            'maximum_discount_amount' => ["required", "numeric", "min:1",'max:999999.99'],
            'coupon_type' => ["required","in:" . implode(",", CouponType::getCouponTypes())],
            'discount_type' => ["required", "in:percentage,fixed"],
            'maximum_redemptions_per_user' => ["nullable",'integer','max:1000000','min:1'],
    ...
    {
        return [
            'title_ar' => '('. __('admin.coupons.title_ar') .')',
            'title_en' => '('. __('admin.coupons.title_en') .')',
