...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "total_weight" => "required|numeric|min:1|max:1000000",
            "net_weight" => "required|numeric|min:1|max:1000000",
            "length" => "nullable|numeric|min:1|max:1000000",
            "width" => "nullable|numeric|min:1|max:1000000",
            "height" => "nullable|numeric|min:1|max:1000000",
