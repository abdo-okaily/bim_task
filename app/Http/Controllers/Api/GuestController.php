...
class GuestController extends ApiController
{
    ...
    {
        $this->middleware('api.guest-customer')->except(['generateToken']);
    }

    public function generateToken() {
        $token = request()->header('X-Guest-Token', null);
    ...
    private function getCartWithRelation(GuestCart $cart) : ?GuestCart {
        ...
        $newCart->totals = PlaceOrder::createPlaceOrderCalculation($this->fromGuestCartToCart($newCart))->getCalculationsInSr();
        return $newCart;
    }
