...
class CustomerCashWithdrawRequestService
{
    ...
    {
        $walletRequest = new IncreaseAndDecreaseWalletBalanceRequest([
            "amount" => $model->amount,
            "type" => WalletHistoryTypeStatus::SUB,
            "transaction_type" => $request->transaction_type,
        ]);
        $walletResult = $this->walletService->increaseAndDecreaseAmount($model->customer->ownWallet->id, $walletRequest);
        if (!$walletResult['success']) throw new Exception($walletResult['body']);
